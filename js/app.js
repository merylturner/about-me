...
// 	else {
// 	alert('Sorry you\'re out of guesses! My favorite number is 8.');
// }
	// else if (i === 3) {
	// alert('Sorry you\'re out of guesses! My favorite number is 8.');
	// console.log(guess);}
...
// TODO check if citiesGuesses matches one of the elements in the cities array
	for (var i = 0; i < 6; i++) {
        ...
        for (var j = 0; j < cities.length; j++) {
            ...
            if (citiesGuess.toUpperCase() === cities[j]) {
                // if (citiesGuess.toUpperCase() === cities[0]|| citiesGuess.toUpperCase() === cities[1] || citiesGuess.toUpperCase() === cities[2]) {
